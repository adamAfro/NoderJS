...
let panel = new Float({ tag: "section", classes: "panel", parent: document.body }, { title: "Edytor" });

panel.handler = new Noder({ tag: "header", classes: "handler" });
new Noder({ tag: "h2", parent: panel.handler , text: "Edytor" });
let editor = new NoderEditor({ target: Noder.select("body .demo > div"), parent: panel });
